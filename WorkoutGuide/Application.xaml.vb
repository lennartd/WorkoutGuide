Class Application
    ...
    Private Shared Sub Application_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
        ...
        MainViewModel.SearchCaracteristics = New SearchFeatures(Nothing, New Categories(True, True, True, True, True, True, True, True, True, True), New Difficulty(), New Duration(), New DateAdded())
    ...
    Private Shared Sub SetTestData()
